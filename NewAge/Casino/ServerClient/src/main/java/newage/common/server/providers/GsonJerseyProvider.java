...
import newage.common.exception.ErrorResponseDeserializer;
import newage.common.exception.ErrorResponseSerializer;
...
public class GsonJerseyProvider implements MessageBodyWriter<Object>, MessageBodyReader<Object> {
	...
	public GsonJerseyProvider() {
		...
		gsonBuilder.registerTypeHierarchyAdapter(ErrorResponse.class, new ErrorResponseSerializer());
		gsonBuilder.registerTypeHierarchyAdapter(ServiceException.class, new ErrorResponseDeserializer());
